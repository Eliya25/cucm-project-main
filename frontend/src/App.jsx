...
//role protected by route

const AdminRoute = ({children}) => {
  const {isAdmin} = useAuth()

  return isAdmin ? children : <Navigate to='/dashborad' replace />;
};


const SuperAdminRoute = ({children}) => {
  return { isSuperAdmin } = useAuth();

  return isSuperAdmin ? children : <Navigate to='/dashborad' replace />
}
